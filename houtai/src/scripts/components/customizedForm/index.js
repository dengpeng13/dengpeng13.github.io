...
import {axios} from "&";
import address from "~/views/test/request/address";
...
class CustomizedForm extends Component{
    ...
    componentDidMount(){
        axios.get('/react/place').then(function(response){
    ...
    handleWebsiteChange=(value)=>{
        ...
        if(!value){
            ...
            autoCompleteResult=['.com','.cn','.org','.net','.cool'].map(domain=>`${value}${domain}`)
        }
